...
- 5 V entry is a **2-pin 2.54 mm header** (J1) instead of the Phoenix screw
  terminal. Same two nodes, same polarity (pad 1 = +, pad 2 = GND).
- Two **external-button headers** (J3, J4) are wired in **parallel** with
