...
So a V1 emulation is perfectly feasible, but it means adding a
`#ifdef VELXIO_EMULATION` shim to `banana-piano.ino` — i.e. rewriting 2019 code
whose value is being the untouched origin. That call is open in
...
diagrammed ([../images/wiring-v1.png](../images/wiring-v1.png)) and its firmware
