# 🍋 Lemon Piano V5.5 — interactive Velxio emulation

> **This is V5's emulation, unchanged and on purpose.** V5.5's only new
> hardware is the power-entry filter — analog supply parts (TVS, choke,
...
> Run every command below **from the version directory** (`versions/v5.5-power-filter/`).
