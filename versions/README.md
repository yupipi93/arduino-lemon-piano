...
| 6 | [v5-led-bar](v5-led-bar/) | Nano only (A6+A7) | − red LED, − MARGIN buttons · + **ten green LEDs** · game select → A7 | ✅ 3 envs | ✅ verify green | [wiring-v5](v5-led-bar/images/wiring-v5.png) |
