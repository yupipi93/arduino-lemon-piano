...
| [images/wiring-v4.png](images/wiring-v4.png) | Full V4 wiring — red/green LED, relay + water pump, D4 game-select |
| [images/wiring-v4-plus.png](images/wiring-v4-plus.png) | V4 + the 2026 touch upgrade (D10/D11 MARGIN buttons) |
...
The three `wiring-*.png` diagrams are generated by
[../tools/wiring_diagrams.py](../tools/wiring_diagrams.py) (pure-PIL, colour-coded
wires + legend) — re-run `python3 tools/wiring_diagrams.py` after a pin-map
change. They now cover the full wiring (keyboard **and** feedback stage) for
every version; the surviving Fritzing diagram covers only the keyboard stage. A
complete Fritzing/KiCad redraw is still on the roadmap ([../TODO.md](../TODO.md)).
For a working, fully-wired reference of V5, the
[Velxio emulation](../emulation/lemon-piano.yaml) spec is verified end-to-end
(10 LEDs + 7 keys + buzzer).
